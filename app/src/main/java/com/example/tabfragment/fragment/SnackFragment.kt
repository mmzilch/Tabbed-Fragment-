...
class SnackFragment : Fragment() {
    ...
    private fun observeViewModel() {
        ...
        foodItemViewModel.detailResult.observe(
            viewLifecycleOwner, Observer {
                ...
                tvSnackError.visibility = View.GONE
                rcySnack.visibility = View.VISIBLE
        ...
        foodItemViewModel.getError().observe(
            viewLifecycleOwner, Observer {
                if (it) {
                    tvSnackError.visibility = View.VISIBLE
                    rcySnack.visibility = View.GONE
                } else {
                    tvSnackError.visibility = View.GONE
                    rcySnack.visibility = View.VISIBLE
                }
    ...
    override fun onResume() {
        super.onResume()
        foodItemViewModel.loadFoodItemsResult(2)
    }
}